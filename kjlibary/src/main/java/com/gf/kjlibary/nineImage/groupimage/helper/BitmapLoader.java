...
import com.gf.kjlibary.nineImage.groupimage.cache.DiskLruCacheHelper;
import com.gf.kjlibary.nineImage.groupimage.cache.LruCacheHelper;
    ...
    private void executeUndoTasks(String url) {
        ...
        try {
            if (undoTasks.containsKey(key)) {
                ...
                List<Runnable> runnables1 = undoTasks.get(key);
                for (Runnable runnable : runnables1) {
